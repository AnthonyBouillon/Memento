...
?>
<!-- Titre de la page -->
<h2 class="text-center">CSS</h2><hr/>
<!-- Barre de recherche -->
<form method="POST">
    ...
    foreach ($readData as $css) {
        if ($css->section === 'CSS') {
            ...
            <div class="fullBlockNoteView">
                ...
                <div class="notesViews" id="notesViews<?= $css->id ?>">
                    <?= $css->description; ?>
                </div>
                ...
                <div class="formNoteViews">
                    <form method="POST">
                        ...
                        <div id="twoButtonViews<?= $css->id ?>">
                        <input type="button" onclick="buttonUpdateNote()" class="buttonUpdate" id="<?= $css->id; ?>" value="MODIFIER" />
                        ...
                        <div id="formUpdateNote<?= $css->id ?>" class="formUpdateNote">
                            <textarea name="description" rows="15" id="description"><?= $css->description; ?></textarea>
