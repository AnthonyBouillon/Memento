...
?>
<!-- Titre de la page -->
<h2 class="text-center">CDN</h2><hr/>
<!-- Barre de recherche -->
<form method="POST">
    ...
    foreach ($readData as $cdn) {
        if ($cdn->section === 'CDN') {
            ...
            <div class="fullBlockNoteView">
                ...
                <div class="notesViews" id="notesViews<?= $cdn->id ?>">
                    <?= $cdn->description; ?>
                </div>
                ...
                <div class="formNoteViews">
                    <form method="POST">
                        <input type="hidden" name="id" value="<?= $cdn->id ?>" />
                        <div id="twoButtonViews<?= $cdn->id ?>">
                        <input type="button" onclick="buttonUpdateNote()" class="buttonUpdate" id="<?= $cdn->id; ?>" value="MODIFIER" />
                        ...
                        <div id="formUpdateNote<?= $cdn->id ?>" class="formUpdateNote">
                            <textarea name="description" rows="15" id="description"><?= $cdn->description; ?></textarea>
