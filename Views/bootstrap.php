...
?>
<!-- Titre de la page -->
<h2 class="text-center">BOOTSTRAP 4</h2><hr/>
<!-- Barre de recherche -->
<form method="POST">
...
<div class="readNote">
    <?php
    foreach ($readData as $bootstrap) {
        if ($bootstrap->section === 'BOOTSTRAP') {
            ?>
            <div class="fullBlockNoteView">
                ...
                <div class="notesViews" id="notesViews<?= $bootstrap->id ?>">
                ...
                <div class="formNoteViews">
                    <form method="POST">
                        <input type="hidden" name="id" value="<?= $bootstrap->id ?>" />
                        <div id="twoButtonViews<?= $bootstrap->id ?>">
                        <input type="button" onclick="buttonUpdateNote()" class="buttonUpdate" id="<?= $bootstrap->id; ?>" value="MODIFIER" />
                        ...
                        <div id="formUpdateNote<?= $bootstrap->id ?>" class="formUpdateNote">
                            <textarea name="description" rows="15" id="description"><?= $bootstrap->description; ?></textarea>
